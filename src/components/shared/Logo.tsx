...
const LogoSvg = () => (
  <svg viewBox="0 0 230 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 md:h-9 w-auto">
    ...
    <rect x="4" y="8" width="42" height="38" rx="3.8" fill="#528982"/>
    {/* Calendar Rings */}
    <rect x="10" y="4" width="5.7" height="7.6" rx="1.9" fill="#528982"/>
    <rect x="29.3" y="4" width="5.7" height="7.6" rx="1.9" fill="#528982"/>
    {/* Sun shape (semicircle on a base) */}
    ...
    {/* Text: "Calendar of Camps" */}
    <text x="55" y="27" fontFamily="Montserrat, Arial, sans-serif" fontSize="19" fontWeight="bold" fill="#B4447A">Calendar</text>
    <text x="55" y="47" fontFamily="Montserrat, Arial, sans-serif" fontSize="19" fontWeight="bold" fill="#B4447A">of Camps</text>
  </svg>
);
